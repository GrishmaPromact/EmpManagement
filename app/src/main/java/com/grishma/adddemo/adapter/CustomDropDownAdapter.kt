...
class CustomDropDownAdapter(val context: Context, var listItemsTxt: ArrayList<String>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) {
            view = mInflater.inflate(R.layout.view_drop_down_item, parent, false)
